...
# 		         ARMAZENAMENTO
# =============================================================
ap_status:      .space 40          # 1 byte por AP
qtd_moradores:  .space 160         # 40 * 4 bytes
moradores:      .space 6000        # (40 APs) * (5 moradores) * (30 caracteres)

tipo_veiculo:   .space 40          # Estado de veículos
modelo_carro:   .space 800         # 40 * 20 bytes
cor_carro:      .space 600         # 40 * 15 bytes
modelo_moto1:   .space 800         # 40 * 20 bytes
cor_moto1:      .space 600         # 40 * 15 bytes
modelo_moto2:   .space 800         # 40 * 20 bytes
cor_moto2:      .space 600         # 40 * 15 bytes
...
str_ap:        .asciiz "AP: "                     # Cabeçalho do AP
str_residents: .asciiz "Moradores:\n"             # Título moradores
str_car:       .asciiz "Carro:\n"                 # Título carro
str_moto:      .asciiz "Moto:\n"                  # Título moto
str_model:     .asciiz "\tModelo: "               # Prefixo modelo
str_color:     .asciiz "\tCor: "                  # Prefixo cor

# Strings para tipos
str_car_cmd:   .asciiz "c"                        # Comando carro
str_moto_cmd:  .asciiz "m"                        # Comando moto

# Arquivo
filename:   .asciiz "condominio.dat"
empty_buffer: .space 10080  # Tamanho total dos dados
...
# Remove newline do buffer de entrada
...
loop_newline:
    ...
    j loop_newline
found_newline:
    sb $zero, 0($t0)       # Substitui newline por null
end_newline:
    jr $ra   
...
# Função tokenize
# Parâmetros:
#   $a0 = endereço da string de entrada (que será modificada)
#   $a1 = endereço do array para armazenar os tokens
# Retorno:
